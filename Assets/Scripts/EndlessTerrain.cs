        ...
        public void UpdateTerrainChunk()
        {
            if (mapDataReceived)
            {
                ...
                if (visible)
                {
                    ...
                    // If the current LOD is the one used for collision, ensure the collider mesh is set up.
                    if (lodIndex == 0)
                    {
                        ...
                        {
                            collisionLODMesh.RequestMesh(mapData); // Request the collision mesh if it hasn't been requested yet.
                        }
                    }
